...
async function generateJWT(options) {
  const { SignJWT } = await import("./esm-H7BQN6WQ.mjs");
...
async function loadSuperJSON() {
  const superjson = await import("./dist-HIYQWKRE.mjs");
...
var TaskCatalogAPI = class _TaskCatalogAPI {
  ...
  setGlobalTaskCatalog(taskCatalog2) {
    return registerGlobal2(API_NAME14, taskCatalog2);
  }
  disable() {
  ...
  #getCatalog() {
    return getGlobal2(API_NAME14) ?? NOOP_TASK_CATALOG;
  }
};
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-66LTAQP7.mjs.map
